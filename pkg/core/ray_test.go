...
func TestPosition(t *testing.T) {
	r := core.NewRay(core.NewPoint(2, 3, 4), core.NewVector(1, 0, 0))
...
func TestHitPositive(t *testing.T) {
	s := core.NewSphere()
	r := core.NewRay(core.NewPoint(0, 0, 1), core.NewVector(0, 0, 1))
	r.AddIntersections(core.NewIntersection(1, s))
	r.AddIntersections(core.NewIntersection(2, s))
	assert.Equal(t, core.NewIntersection(1, s), (*r.Hit()))
}
...
func TestHitMixedMultipePositive(t *testing.T) {
	s := core.NewSphere()
	r := core.NewRay(core.NewPoint(0, 0, 1), core.NewVector(0, 0, 1))
	r.AddIntersections(core.NewIntersection(5, s))
	r.AddIntersections(core.NewIntersection(7, s))
	r.AddIntersections(core.NewIntersection(-3, s))
	r.AddIntersections(core.NewIntersection(2, s))
	assert.Equal(t, core.NewIntersection(2, s), (*r.Hit()))
}

func TestRayTranslation(t *testing.T) {
	r := core.NewRay(core.NewPoint(1, 2, 3), core.NewVector(0, 1, 0))
